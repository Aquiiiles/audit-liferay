...
package com.liferay.audit.service.base;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.audit.service.impl.AuditEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.audit.service.impl.AuditEntryLocalServiceImpl
 * @generated
 */
public abstract class AuditEntryLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AuditEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.audit.service.AuditEntryLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return auditEntryPersistence.dslQuery(dslQuery);
	}
	...
	public AuditEntry fetchAuditEntryByUuidAndGroupId(
		...
		return auditEntryPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return auditEntryPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AuditEntryLocalServiceImpl#deleteAuditEntry(AuditEntry) to avoid orphaned data");
		}
	...
	public List<AuditEntry> getAuditEntriesByUuidAndCompanyId(
		...
		return auditEntryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<AuditEntry> getAuditEntriesByUuidAndCompanyId(
		...
		return auditEntryPersistence.findByUuid_C(
	...
	public AuditEntry getAuditEntryByUuidAndGroupId(String uuid, long groupId)
		...
		return auditEntryPersistence.findByUUID_G(uuid, groupId);
	}
